"""Scanner module: file/directory traversal and symbol extraction via ast-grep."""
...
def sg_json(pattern: str, lang: str, filepath: str):
...
def _filter_inner_vars(symbols: list[Symbol], lang: str, path: str) -> list[Symbol]:
    ...
    if lang == 'python':
        for m in sg_json('if __name__ == $VAL: $$$BODY', lang, path):
